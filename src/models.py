# The source code: https://github.com/willisma/SiT
...
class SiT(nn.Module):
    ...
    def forward(self, x, t, y, r=None):
        ...
        r: target timesteps (Only required for MeanFlow)
        """
        ...
        if self.ifMeanFlow and r is not None:
            r_emb = self.r_embedder(r)
            c = c + r_emb  # 初始时 r_emb 全为 0，完美等效！
...
def SiT_XL_2_MeanFlow(**kwargs):
    return SiT(depth=28, hidden_size=1152, patch_size=2, num_heads=16, ifMeanFlow=True, **kwargs)
...
SiT_models = {
    ...
    'SiT-XL/2-MeanFlow': SiT_XL_2_MeanFlow
}